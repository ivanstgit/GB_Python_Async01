from gb_python_async01.server.core.model import *
from gb_python_async01.server.db.model import *
from gb_python_async01.transport.model.message import JIMUser, JIMActionMessage
...
class UserSessionSerializer():
    ...
    def from_db(user_last_session: UserSession) -> UserSessionInfo:
        return UserSessionInfo(id=user_last_session.id,
